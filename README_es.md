...
- El objetivo inicial era crear un script para publicar automáticamente capítulos de novelas en 番茄小说 (Fanqie Novel), lo cual inevitablemente requeriría modelos de lenguaje grandes.
- Consulté a Gemini y Grok para obtener soluciones, y elegí browser-use como el componente de código abierto. También probé otros navegadores AI y plugins pero no quedé satisfecho.
- Después de determinar la solución, usé VSCode + KiloCode agent, con modelos grandes incluyendo GLM 4.7, Minimax 2.5, GLM 5, Step 3.5 Flash, Qwen3.5 397B/122B, etc.
- El programa siempre fue inestable con varios problemas menores. Finalmente, cambié a Gemini 3.1 Pro, que lo estabilizó rápidamente, y agregué continuamente nuevas funciones, lográndolas a la primera en su mayoría.
- También soy un programador senior (empecé a programar en 1995), pero nunca he usado Python, así que nunca he depurado una sola línea de código, ni siquiera he mirado mucho el código.
- Tardé aproximadamente un día completo en completar este proyecto.
...
# Ejecutar un solo comando directamente (abrir navegador, ejecutar comando, cerrar navegador)
...
Continuando con las pruebas del modelo 4B de Qwen3.5
